...
Route đã công bố không ghi đè; nếu có sẵn, bỏ qua lệnh prepare. JSON kết quả DeepSeek cũng đi cùng repo; xem [bàn giao dữ liệu demo](docs/DEMO_HANDOFF.vi.md#dữ-liệu-demo-đi-cùng-repo). Key, chứng chỉ, video nguồn và runtime khác bị Git bỏ qua.

- [Hướng dẫn chạy, teach, HTTPS và thiết bị](docs/PROTOTYPE_RUNBOOK.vi.md)
- [Kết quả kiểm thử và giới hạn đã biết](docs/PROTOTYPE_VERIFICATION.vi.md)
- [Bản duyệt tuyến demo](data/examples/lift-lobby-to-toilet-v1/README.vi.md)
- [Checklist demo, deck/video và thử tại hiện trường](docs/DEMO_HANDOFF.vi.md)
- [Video nguồn: thư mục Google Drive và bản cục bộ](docs/DEMO_HANDOFF.vi.md#video-nguồn)
